...
class DataAggregation:
    ...
    def shape_data_to_gold(self, df):
        ...
        try:
            ...
            locations_df.write.mode("overwrite").csv(
                f"{self.gold_path}/locations_data.csv", header=True
            )
            ...
            vendors_df.write.mode("overwrite").csv(
                f"{self.gold_path}/vendors_data.csv", header=True
            )
